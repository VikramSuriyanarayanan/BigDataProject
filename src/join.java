...
//**********************************
	...
	JobConf job = new JobConf(new Configuration(), Join.class); // Create a JobConf object
   ...
   // if (conf.isSuccessful())*/
   	 ...
   	 // job.setReducerClass(Top10Reducer.class);
   	  ...
   	  job.setOutputValueClass(Text.class);
   	   MultipleInputs.addInputPath(job, new Path(args[0]),org.apache.hadoop.mapreduce.lib.input.TextInputFormat.class,HostCntryMapper.class);
